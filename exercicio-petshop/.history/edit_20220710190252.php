...
<!-- exibindo os dados -->
<table width="60%" border="0" cellspacing="12px">
    <form method="POST">
    <tr bgcolor="#DFDFDF" style="color: #090503; font-family: 'Poppins', cursive; font-size: 1.2rem" cellpadding="16px">
        <th>
    ...
    <tr>
        <td>
            <input 
                ...
                style="width: 100%;padding: 0.36rem;"
            />
        </td>
        <td>
            <input 
